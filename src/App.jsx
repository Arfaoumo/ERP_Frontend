      ...
      <BrowserRouter>
        <div className="min-h-screen bg-background font-sans text-foreground relative">
          ...
          <button 
            ...
            className="fixed bottom-6 right-6 z-50 px-4 py-2.5 bg-slate-900 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-800 hover:shadow-xl hover:shadow-slate-900/20 hover:-translate-y-1 transition-all duration-300 active:scale-95 flex items-center gap-2 border border-slate-700"
          ...
          <ProtectedRoute allowedRoles={['Admin', 'Employee_Stocks']}><ProductForm /></ProtectedRoute>
        } />
        <Route path="/inventory/edit/:id" element={
          <ProtectedRoute allowedRoles={['Admin', 'Employee_Stocks']}><ProductEditForm /></ProtectedRoute>
        } />
