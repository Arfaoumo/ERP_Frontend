          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              {(previewUrl || formData.imageUrl) ? (
                <img src={previewUrl || (formData.imageUrl.startsWith('/uploads') ? `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}${formData.imageUrl}` : formData.imageUrl)} alt="Preview" className="w-16 h-16 rounded-xl object-cover border border-slate-200 shadow-sm" />
              ) : (
