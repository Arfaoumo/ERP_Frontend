        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full p-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-sm font-bold text-slate-900 placeholder:text-slate-300"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full p-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-sm font-bold text-slate-900 font-mono placeholder:text-slate-300"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder={t('customers.shippingAddressPlaceholder')}
              className="w-full p-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-sm font-bold text-slate-900 placeholder:text-slate-300"
            ></textarea>
          </div>

          {isEditMode && (
            <div className="flex items-center p-6 bg-slate-50/50 rounded-2xl border border-slate-100">
              <input 
                type="checkbox" 
                id="isActive" 
